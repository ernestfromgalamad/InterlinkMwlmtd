...
<html
  ...
  <head>
    ...
    <title>Intelink-My Projects</title>
                ...
                <div class="card shadow-sm border-0"
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-white" style="font-size: 18px;">
                            Manage your job postings, track applications, and find the right talent for your needs.
                        </p>
                        <a href="add_job_form.php" class="btn btn-light btn-lg shadow-sm">
                            <i class="fas fa-plus-square"></i>  Post a New Job
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            if (isset($_SESSION['user_id'])) {
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $job_tags = htmlspecialchars($row['job_tags']);
            ?>
                    <div class="col-12 col-md-6 col-lg-4 mb-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body">
                                <h5 class="card-title text-primary"><?php echo $job_title; ?></h5>
                                <p class="card-text"><?php echo $job_description; ?></p>
                                <p class="card-text"><strong>Location:</strong> <?php echo $job_location; ?></p>
                                <p class="card-text"><strong>Type:</strong> <?php echo $job_type; ?></p>
                                <p class="card-text"><strong>Tags:</strong> <?php echo $job_tags; ?></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-muted">Posted on: <?php echo date('F j, Y', strtotime($created_at)); ?></small>
                                    <!-- Edit and Delete Buttons -->
                                    <div>
                                        <a href="edit_job.php?id=<?php echo $row['job_id']; ?>" class="btn btn-sm btn-outline-warning">Edit</a>
                                        <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $row['job_id']; ?>">Delete</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="deleteModal<?php echo $row['job_id']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            ...
            <?php } } else { ?>
                <p>You must be logged in to view your job postings.</p>
            <?php } ?>
        </div>
    </div>
    <!-- / Content -->

...
<div class="container py-4">
    ...
    ?>
        <div class="col mb-4">
            <div class="card h-100" style="font-size: 1rem; border: none;">
                <div class="position-relative">
                <img src="<?php echo $project_media; ?>" class="card-img-top img-thumbnail" alt="Project Image" style="width: 100%; height: 200px; object-fit: cover;" data-bs-toggle="modal" data-bs-target="#projectModal<?php echo $row['id']; ?>">

        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <!-- Add Recent Project Form -->
                        <form id="formAddProject" method="POST" action="add_project.php" enctype="multipart/form-data">
                            <div class="row g-3">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="projectDescription" name="project_description" placeholder="Describe your project in detail..." rows="4" required></textarea>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <label for="projectMedia" class="form-label">Upload Media</label>
                                    <input type="file" class="form-control" id="projectMedia" name="project_media" accept="image/*,video/*,application/pdf" />
                                    <small class="form-text text-muted">You can upload images, videos, or PDFs related to your project.</small>
                                </div>
                                <div class="col-md-12">
                                    <label for="projectTags" class="form-label">Tags (Optional)</label>
                                    <input type="text" class="form-control" id="projectTags" name="project_tags" placeholder="Enter tags separated by commas (e.g., design, branding, SEO)" />
                                </div>
                            </div>

                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary me-3">Add Project</button>

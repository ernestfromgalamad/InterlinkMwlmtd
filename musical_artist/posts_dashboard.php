  ...
  <body>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-12 mb-4">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="content_form.php" class="btn btn-primary btn-lg shadow-sm">Upload New Content</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            $stmt = $pdo->query("SELECT * FROM `content` WHERE `visibility` = 'public' ORDER BY `created_at` DESC");
            ...
            ?>
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card shadow-sm h-100">
                        <!-- Image Thumbnail -->
                        <img src="<?php echo $media; ?>" class="card-img-top img-thumbnail" alt="Content Image" data-bs-toggle="modal" data-bs-target="#imageModal<?php echo $row['id']; ?>">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="edit_content.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-outline-warning">Edit</a>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="imageModalLabel"><?php echo $title; ?></h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body text-center">
                                <img src="<?php echo $media; ?>" class="img-fluid" alt="Full Content Image">
                            </div>
                        </div>
                    </div>
                </div>
